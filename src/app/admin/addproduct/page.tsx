...
export default function AddProductPage() {
  ...
  const [specs, setSpecs] = useState<Array<{ key: string; value: string }>>([
    ...
    { key: "Gears", value: "21-Speed Shimano" },
    { key: "Brakes", value: "Mechanical Disc" },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(err?.data?.error || "Failed to create product.");
    }
  };
      ...
      <div className="flex-1 space-y-6 p-8">
        ...
        <header className="flex items-center gap-3 border-b border-zinc-200 dark:border-zinc-800 pb-4">
          ...
          <div className="text-left">
            ...
            <p className="text-xs text-zinc-500 mt-1">Insert a new cycle model into the catalog.</p>
          </div>
        </header>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-5xl">
          ...
          <div className="lg:col-span-8 bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                placeholder="e.g. Oxford City Ride v4"
                className="w-full px-3.5 py-2.5 text-xs border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950 rounded-xl focus:outline-none focus:ring-1 focus:ring-green-500"
                required
              />
            </div>
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    // Match type text for backward compatibility
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                placeholder="Product descriptions must details the build quality and targeted experience..."
                className="w-full px-3.5 py-2.5 text-xs border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950 rounded-xl focus:outline-none focus:ring-1 focus:ring-green-500"
                required
              />
            </div>
                ...
                {specs.map((row, index) => (
                  <div key={index} className="flex gap-3 items-center">
                    ...
                    <input
                      ...
                      placeholder="e.g., Shimano 21 gears"
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="e.g., 499"
                  className="w-full px-3 py-2.5 text-xs border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950 rounded-xl focus:outline-none"
                  required
                />
              </div>
            ...
            >
              <Save className="w-4 h-4" /> {isSaving ? "Saving..." : "Save Product Listing"}
            </button>
